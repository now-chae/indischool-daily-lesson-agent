...
1. 사용자가 설정한 학교 홈페이지의 주간학습안내에서 오늘 날짜와 담당 학년·반 시간표를 확인합니다.
2. 설정에서 지정한 전담 과목을 제외한 수업의 학습 주제를 읽습니다.
3. 과목별 규칙에 맞는 핵심 검색어를 만듭니다.
4. 인디스쿨에서 설정한 학년 게시판의 관련 자료를 찾고 제목·링크·한 줄 요약을 정리합니다.
...
질문이 나오면 **근무 학교의 주간학습안내 주소, 담당 학년·반, 제외할 전담 과목, Kakao REST API 키**를 입력합니다. OpenAI 키가 없으면 그냥 Enter를 눌러도 됩니다.
